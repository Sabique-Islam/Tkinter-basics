    ...
    if accept == "Accepted":
        ...
        if fname and lname:
            ...
            query = """CREATE TABLE IF NOT EXISTS Data 
                    (title TEXT,fname TEXT, lname TEXT,age INT, nation TEXT, courses INT, semester INT,registration_status TEXT)
            """
            conn.execute(query)

            data_insert_query = """INSERT INTO Data (title, fname, lname, 
            age, nation,courses,semester, registration_status) VALUES 
            (?, ?, ?, ?, ?, ?, ?, ?)"""
            data_insert_tuple = (title, fname, lname, age, nation,courses,semester, registration_status)
            cursor = conn.cursor()
